...
| `app` | Placement operations (create, get, delete, lifecycle)
...
The `shared-cluster-manager` cannot access admin-only endpoints (enable/disable, health, delete, JWT management, DNS, IBM, reservations, placements).
