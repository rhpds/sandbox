...
func (h *BaseHandler) GetPlacementHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err := placement.LoadActiveResourcesWithCreds(h.awsAccountProvider, h.OcpSandboxProvider, h.DNSSandboxProvider, h.IBMSharedSandboxProvider); err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		render.Render(w, r, &v1.Error{
			Err:            err,
			HTTPStatusCode: http.StatusInternalServerError,
...
func (h *BaseHandler) DeletePlacementHandler(w http.ResponseWriter, r *http.Request) {
	...
	go placement.Delete(h.awsAccountProvider, h.OcpSandboxProvider, h.DNSSandboxProvider, h.IBMSharedSandboxProvider)
